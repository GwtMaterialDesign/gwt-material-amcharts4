...
public class AmChartsTheme implements ChartTheme {

    @Override
    public void loadResource() {
        GwtMaterialAmCore.injectJs(ThemeClientBundle.INSTANCE.amchartsJs());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_amcharts");
    }
}
