...
public class SpiritedAwayTheme implements ChartTheme {

    @Override
    public void loadResource() {
        MaterialDesignBase.injectJs(ThemeClientBundle.INSTANCE.spiritedAway());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_spiritedaway");
    }
}
