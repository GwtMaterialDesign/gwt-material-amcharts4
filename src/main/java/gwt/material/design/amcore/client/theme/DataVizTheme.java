...
public class DataVizTheme implements ChartTheme {

    @Override
    public void loadResource() {
        MaterialDesignBase.injectJs(ThemeClientBundle.INSTANCE.dataVizJs());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_dataviz");
    }
}
