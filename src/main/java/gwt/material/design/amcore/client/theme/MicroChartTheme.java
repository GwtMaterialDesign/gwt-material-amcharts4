...
public class MicroChartTheme implements ChartTheme {

    @Override
    public void loadResource() {
        GwtMaterialAmCore.injectJs(ThemeClientBundle.INSTANCE.microchartJs());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_microchart");
    }
}
