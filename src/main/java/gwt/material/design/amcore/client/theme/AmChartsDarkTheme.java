...
public class AmChartsDarkTheme implements ChartTheme {

    @Override
    public void loadResource() {
        GwtMaterialAmCore.injectJs(ThemeClientBundle.INSTANCE.amchartsdarkJs());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_amchartsdark");
    }
}
