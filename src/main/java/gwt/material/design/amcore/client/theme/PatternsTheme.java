...
public class PatternsTheme implements ChartTheme {

    @Override
    public void loadResource() {
        GwtMaterialAmCore.injectJs(ThemeClientBundle.INSTANCE.patternsJs());
    }

    @Override
    public Object get() {
        return window().getPropertyObject("am4themes_patterns");
    }
}
